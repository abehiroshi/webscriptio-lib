...
function m.send(args)
    ...
    if not message_type and args.replyToken and args.replyToken ~= '' then message_type = 'reply' end
    if not message_type and args.to and args.to ~= '' then message_type = 'push' end
